...
Revision ID: 2e30625f26b2
Revises: 
Create Date: 2024-06-04 11:09:43.217295
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nom', sa.String(length=150), nullable=False),
    sa.Column('capacite', sa.String(length=150), nullable=False),
