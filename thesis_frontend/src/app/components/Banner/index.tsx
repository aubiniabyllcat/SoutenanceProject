                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <Fade direction={'up'} delay={1000} cascade damping={1e-1} triggerOnce={true}>
                            <div className='md:flex align-middle justify-center lg:justify-start'>
                                ...
                                <button className='flex border w-full md:w-auto mt-5 md:mt-0 justify-center rounded-full text-xl font-medium items-center py-5 px-10 text-dark hover:bg-green-400 hover:text-white hover:border-zinc-50 border-stone-500 '><Link href='#about-section' >Commencer</Link></button>
