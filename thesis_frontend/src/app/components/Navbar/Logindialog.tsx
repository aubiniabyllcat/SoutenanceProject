                                    ...
                                    <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                                        <div className="w-full max-w-md space-y-8">
                                            <div>
                                                ...
                                                <h3 className="mt-10 text-center text-3xl font-bold tracking-tight text-lightgrey">
                                                ...
                                                <div className="-space-y-px rounded-md shadow-sm ">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            autoComplete="email"
                                                            required
                                                            className="relative block w-full appearance-none rounded-none rounded-t-md border border-lightgrey border-opacity-40 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm mb-3"
...
Mot de passe oublié?                                                        </a>
                                                ...
                                                <div>
                                                    <button
                                                        type="submit"
                                                        className="group relative flex w-full justify-center rounded-md border  bg-dark py-2 px-4 text-sm font-medium text-indigo-500 bg-dark hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                                    >
