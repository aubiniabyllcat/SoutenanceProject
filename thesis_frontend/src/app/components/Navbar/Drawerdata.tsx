            ...
            <div className="flex-1 space-y-4 py-1">
                <div className="sm:block">
                    <div className="space-y-1 px-5 pt-2 pb-3">
                        ...
                        <button className='flex justify-center text-base w-full font-medium rounded-full text-pink py-3 px-4 lg:px-8 navbutton hover:bg-cyan-400'>Se connecter</button>
